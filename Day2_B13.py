# How to decaler variable and add int variable
a = 10 # decaler
b = 10 
# add a and b int variable and store new variable
c = a+b
#print new variable ( a+b )
print(c)

# How to decaler variable in charter
First_Name = "udit" # variable declar in small case
